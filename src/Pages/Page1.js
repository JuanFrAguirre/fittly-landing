  ...
  return (
    <Container fluid className="d-flex header">
      <Container>
        ...
        <Row className="h-100 d-flex d-flex align-items-sm-center align-items-start ">
          <Col className="col-12 col-md-5 col-lg-6 d-flex flex-column justify-content-center justify-content-sm-start">
            ...
            <p className="subtitle text-md-left text-center">
              We help Fitness Professionals Level up, advance their careers and
              their business by providing the network, tools & resources they
