...
const Page4 = () => {
  ...
  return (
    <Container fluid className="mainContainerStep4">
      <Row className="orangeBG">
        <Container>
          <Row className="step4">
            <Col>
              <h2 className="text-center mb-5">Opportunities for growth</h2>
          ...
          <Row className="formNewsletter">
            <Col>
              <Row>
                <Col md={12}>
                  <h3>
                    Sign up today to find the community you need to help your
                    business grow!
                  </h3>
                </Col>
              </Row>
              ...
              <Row>
                <Col md={10} xs={8} className="mx-auto">
                  <Row className="optionsCheck">
                    <Col md={4} xs={12}>
                      <p>
                        <img src={check} alt="Fittly" />
                        <br className="d-block d-sm-none" /> Access to quality
                        job posts
                      </p>
                    </Col>
                    <Col md={4} xs={12}>
                      <p>
                        ...
                        Public Profile to Promote your skills
                      </p>
                    </Col>
                    <Col md={4} xs={12}>
                      <p>
                        <img src={check} alt="Fittly" />
                        <br className="d-block d-sm-none" /> Tons of networking
                        opportunities
                      </p>
                    </Col>
                  </Row>
